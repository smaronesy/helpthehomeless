...
class HomelessListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val hl1 = Homeless("souhayl@gmail.com", "Souhayl", "Maronesy", "6194169878", true, "2022-06-26")
        val hl2 = Homeless("petera@gmail.com", "Peter", "Adams", "6124199428", false, "2021-05-02")
